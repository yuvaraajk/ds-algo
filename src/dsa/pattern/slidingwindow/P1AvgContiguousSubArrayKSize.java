...
public class P1AvgContiguousSubArrayKSize {
  ...
  /**
   * Find the average of all contiguous subarrays of size ‘K’ in the given array. This is brute
   * force approach, it takes O(N * K) time to compute the average of subarray of size K.
   *
   * @param arr
   * @param k
   * @return
  ...
  /**
   * Find the average of all contiguous subarrays of size ‘K’ in the given array. Using sliding
   * window approach, it takes O(N) time to compute the average of subarray of size K.
   *
   * @param arr
   * @param k
   * @return
