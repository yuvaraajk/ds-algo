...
public class P6NoRepeatSubstring {
     ...
     * 1. Iterate over the string, maintain the window start and end index
     * 2. check if char already exists then move to start index to duplicate char
     *
     * @param input
     * @return
     */
    ...
    public static void main(String[] args) {
        System.out.println("Longest substring which has no repeating chars: " + findNoRepeatChars("aabccbb"));
    }
}
